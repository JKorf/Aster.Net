...
namespace Aster.Net.UnitTests
{
    ...
    internal class SharedRestIntegrationTests
    {
        ...
        private IAsterRestClientSpotV3ApiShared GetSpotRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddAster(x => x.Rest.OutputOriginalData = true);
            ...
            return sp.GetRequiredService<IAsterRestClient>().SpotV3Api.SharedClient;
        }

        private IAsterRestClientFuturesV3ApiShared GetFuturesRestClient()
        {
            var collection = new ServiceCollection();
            collection.AddAster(x => x.Rest.OutputOriginalData = true);
            collection.AddLogging(x =>
            ...
            var sp = collection.BuildServiceProvider();
            return sp.GetRequiredService<IAsterRestClient>().FuturesV3Api.SharedClient;
        }
