...
/// </summary>
public record AsterStrategyOrderEditResult
{
    /// <summary>
    ...
    /// <summary>
    /// ["<c>updatedSubOrder</c>"] Updated sub order count
    /// </summary>
    [JsonPropertyName("updatedSubOrder")]
    public int UpdatedSubOrders { get; set; }
    /// <summary>
    /// ["<c>updateStatus</c>"] Update status
    /// </summary>
