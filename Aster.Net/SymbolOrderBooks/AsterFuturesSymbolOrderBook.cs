...
namespace Aster.Net.SymbolOrderBooks
{
    ...
    /// </summary>
    public class AsterFuturesSymbolOrderBook : SymbolOrderBook
    {
        ...
        public AsterFuturesSymbolOrderBook(string symbol, Action<AsterOrderBookOptions>? optionsDelegate = null)
        ...
        public AsterFuturesSymbolOrderBook(
            string symbol,
            Action<AsterOrderBookOptions>? optionsDelegate,
            ILoggerFactory? logger,
            IAsterRestClient? restClient,
            IAsterSocketClient? socketClient) : base(logger, "Aster", "Futures", symbol)
        {
        ...
        protected override async Task<CallResult<UpdateSubscription>> DoStartAsync(CancellationToken ct)
        {
            ...
            if (Levels == null)
                subResult = await _socketClient.FuturesApi.SubscribeToOrderBookUpdatesAsync(Symbol, _updateInterval, HandleUpdate).ConfigureAwait(false);
            else
                subResult = await _socketClient.FuturesApi.SubscribeToPartialOrderBookUpdatesAsync(Symbol, Levels.Value, _updateInterval, HandleUpdate).ConfigureAwait(false);
