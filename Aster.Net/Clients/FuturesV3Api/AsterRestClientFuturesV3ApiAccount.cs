...
namespace Aster.Net.Clients.FuturesV3Api
{
    ...
    internal class AsterRestClientFuturesV3ApiAccount : IAsterRestClientFuturesV3ApiAccount
    {
        ...
        public async Task<WebCallResult<AsterAccountInfo>> GetAccountInfoAsync(long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            var request = _definitions.GetOrCreate(HttpMethod.Get, "/fapi/v3/accountWithJoinMargin", AsterExchange.RateLimiter.RestIp, 5, true);
        ...
        {
            var request = _definitions.GetOrCreate(HttpMethod.Post, "fapi/v3/listenKey", AsterExchange.RateLimiter.RestIp, 1, true);
        ...
        public async Task<WebCallResult> KeepAliveUserStreamAsync(string listenKey, CancellationToken ct = default)
        {
            ...
            var request = _definitions.GetOrCreate(HttpMethod.Put, "fapi/v3/listenKey", AsterExchange.RateLimiter.RestIp, 1, true);
        ...
        public async Task<WebCallResult> StopUserStreamAsync(string listenKey, CancellationToken ct = default)
        {
            ...
            var request = _definitions.GetOrCreate(HttpMethod.Delete, "fapi/v3/listenKey", AsterExchange.RateLimiter.RestIp, 1, true);
            return await _baseClient.SendAsync(request, parameters, ct).ConfigureAwait(false);
        }
