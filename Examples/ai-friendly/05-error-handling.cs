...
var result = await client.SpotV3Api.ExchangeData.GetTickerAsync("BTCUSDT");
...
var ticker = await WithRetry(
    () => client.SpotV3Api.ExchangeData.GetTickerAsync("BTCUSDT"));
...
// Aster.Net returns API/network/rate-limit errors via WebCallResult.Error.
...
//   Futures V3:              client.FuturesV3Api.* follows the same result pattern
