...
var trackerFactory = provider.GetRequiredService<IAsterTrackerFactory>();

// Create and start the tracker, keep track of the last 10 minutes
var tracker = trackerFactory.CreateTradeTracker(new SharedSymbol(TradingMode.Spot, "ASTER", "USDT"), period: TimeSpan.FromMinutes(10));
